            ...
            <div id="pdf-content" className="p-4 sm:p-0">
                    ...
                    <div className="relative z-10 flex items-center justify-center gap-3 mb-4">
                        {data.realtor?.subscriptionTier === 'PRO_PLUS' && data.realtor?.customLogoUrl ? (
                            ...
                            <>
                                ...
                                <h2 className="text-4xl font-extrabold tracking-tight">Evin Değeri</h2>
                            </>
                        )}
                    </div>
                ...
                <div className="pdf-only-item mt-12 pt-8 border-t border-gray-200 flex-col items-center justify-center text-center">
                    <div className="flex items-center gap-2 text-appleDark font-bold mb-4 opacity-70">
                        ...
                        <span className="text-xl">Evin Değeri</span>
                    </div>
                    <p className="text-[11px] text-gray-500 leading-relaxed max-w-4xl text-justify">
                        <strong className="text-gray-700">Yasal Uyari:</strong> Bu raporda sunulan degerleme sonucu, TCMB verileri, bolgesel enflasyon oranlari ve yapay zeka tarafindan saglanan gecmis satis istatistiklerine dayali matematiksel bir projeksiyondur. Kesinlikle bir gayrimenkul ekspertiz raporu veya herhangi bir ticari faaliyet icin <strong className="font-bold">yatirim tavsiyesi niteligini tasimaz</strong>. Evin Değeri, bu rapor sonucunda dogabilecek dogrudan veya dolayli alim/satim, kiralama kaynakli maddi zararlardan hukuken sorumlu tutulamaz. Detayli piyasa kararlari icin lisansli uzmanlara basvurmaniz onerilir.
                    </p>
